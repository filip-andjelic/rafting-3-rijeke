angular.module('archApp')
    .service('Categories', function() {
        ...
        /**
         * Sets default types of items in the App.
         * Each type's list is accessible via sidebar tab.
         * Each type's new item can be created and added to the App.
         */
        ...
        function getUserClassSuffix(entry) {
            if (entry.role) {
                if (entry.role.toLowerCase() === 'admin') {
                    return 'fa-lock';
                }
